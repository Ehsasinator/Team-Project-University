...
export class PlayerService {
  ...
  updateProfilePicture(playerId: number, imageUrl: string): Observable<EntityResponseType> {
    const body = { playerIcon: imageUrl }; // Assuming 'playerIcon' is the property to update the profile picture
    return this.http.patch<IPlayer>(`${this.resourceUrl}/${playerId}/profile-picture`, body, { observe: 'response' });
  }
