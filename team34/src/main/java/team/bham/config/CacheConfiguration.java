...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, team.bham.domain.UserSettings.class.getName());
            ...
            createCache(cm, team.bham.domain.Competition.class.getName() + ".entries");
            createCache(cm, team.bham.domain.Entry.class.getName());
            createCache(cm, team.bham.domain.Entry.class.getName() + ".likes");
            createCache(cm, team.bham.domain.Entry.class.getName() + ".comments");
            createCache(cm, team.bham.domain.Entry.class.getName() + ".reports");
            createCache(cm, team.bham.domain.Comment.class.getName());
            createCache(cm, team.bham.domain.Report.class.getName());
            createCache(cm, team.bham.domain.Like.class.getName());
