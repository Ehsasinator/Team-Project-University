...
class ReportResourceIT {
    ...
    public static Report createEntity(EntityManager em) {
        Report report = new Report().comment(DEFAULT_COMMENT).date(DEFAULT_DATE);
        return report;
    }
    ...
    public static Report createUpdatedEntity(EntityManager em) {
        Report report = new Report().comment(UPDATED_COMMENT).date(UPDATED_DATE);
        return report;
    }
    ...
    void getAllReportsWithEagerRelationshipsIsEnabled() throws Exception {
        when(reportRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
    ...
    void putExistingReport() throws Exception {
        ...
        updatedReport.comment(UPDATED_COMMENT).date(UPDATED_DATE);
    ...
    void partialUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.date(UPDATED_DATE);
    ...
    void fullUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.comment(UPDATED_COMMENT).date(UPDATED_DATE);
